/**
 * Created by salihkilic on 08/07/16.
 */
/**
 * Created by salihkilic on 07/01/16.
 */
$(function () {
    ...
    beforeSlug.append('<div class="col-sm-12"><div class="slug info" style="margin-top: 5px;">' +
        ...
        '<input name="slug_name" data-value="" type="hidden">' +
        '</div></div>');
...
function getSlug(slug, _token, model) {
    ...
    $.ajax({
        ...
        success: function (output) {
            ...
            $('input[name="slug_name"]').val(output);
